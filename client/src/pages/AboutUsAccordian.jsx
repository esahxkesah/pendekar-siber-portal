  ...
  return (
    <div className="container mx-auto p-8">
      ...
      <div className="flex justify-center p-8">
        <img
          src="https://i.postimg.cc/pVBSxML0/Pendekar-Siber-Banner.png" alt="About Us Banner" className="w-full max-w-7xl"
        />
      </div>
      <div className="object-cover rounded-t-lg shadow-md" style={{ paddingBottom: "60px" , paddingTop: "60px" }}>
        <div style={{ width: "100%", maxWidth: "1200px", margin: "0 auto" }}>

      {/* Background of Pendekar Siber */}
      <div className="my-1">
      <div style={{ textAlign: 'justify', width: "100%", maxWidth: "1200px", margin: "0 auto" }}>

  ...
  return (
    <div className="container mx-auto p-8">
      <div className="text-center py-3">
        <h1 style={{  paddingBottom: "40px" }} className="text-3xl font-bold text-center ">About Us</h1>
      </div>
          ...
          <li>
            <button
              className="navigation-button" style={{
                ...
                transition: 'background-color 0.3s ease', // Smooth transition for background color
                color: 'darkblue' }}
              onClick={() => scrollToSection(event2Ref)}> Jom Jadi Pendekar Siber <br></br>at AYG Puchong
            </button>
          </li>
          ...
          <li>
            <button
              className="navigation-button" style={{
                ...
                transition: 'background-color 0.3s ease', // Smooth transition for background color
                color: 'darkblue' }}
              onClick={() => scrollToSection(event3Ref)}> The Pendekar Siber <br></br>Youth Program
            </button>
          </li>
          ...
          <li>
            <button
              className="navigation-button" style={{
                ...
                transition: 'background-color 0.3s ease', // Smooth transition for background color
                color: 'darkblue'}}
              onClick={() => scrollToSection(event4Ref)}> Site Visit to Bank<br></br> Islam
            </button>
            </li>
